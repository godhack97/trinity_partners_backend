...
export class Bitrix24AdminController {
  ...
  @ApiParam({
    name: "id",
    description: "ID сделки для синхронизации",
    type: "number",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiParam({
    name: "id",
    description: "ID сделки для конвертации лида",
    type: "number",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiParam({
    name: "id",
    description: "ID сделки для обновления лида",
    type: "number",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: "Проверка существования синхронизированных лидов в Bitrix24",
  })
  @ApiResponse({
    status: 200,
  ...
  async runSyncNow(@Body() _confirmation: ConfirmBitrix24OperationDto) {
    ...
    return {
      message:
        "Синхронизация неотправленных лидов запущена в фоне. Проверьте логи для получения результатов.",
  ...
  @ApiOperation({
    summary: "Детальная статистика синхронизации и конвертации лидов",
  })
  @ApiResponse({
    status: 200,
  ...
  async getDetailedLeadStatistics() {
    ...
    return {
      ...
      description: {
        ...
        processing: "Лиды, синхронизация которых выполняется сейчас",
        ...
        conversionRate:
          "Процент конвертации лидов в сделки от синхронизированных",
      },
    };
  }
