...
export class CreateUserSettingsTable1745422080901 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropForeignKey('user_table_settings', 'FK_user_table_settings_user_id');
