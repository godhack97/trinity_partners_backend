...
import { AdminUserAdminService, SearchRoleAdminTypes } from "@api/admin/user/admin/admin-user-admin.service";
...
export class AdminCountsController {
    ...
    async getAllCounts() {
        const [
            ...
            this.adminUserAdminService.getCountByRole(SearchRoleAdminTypes.SuperAdmin),
            this.adminUserAdminService.getCountByRole(SearchRoleAdminTypes.ContentManager),
