export enum UserActionType {
  ...
  export const UserActionLabels: Record<UserActionType, string> = {
    ...
    [UserActionType.CONFIGURATOR_PROCESSORGENERATION_ADD]: 'Добавлено поколение процессоров',
    [UserActionType.CONFIGURATOR_PROCESSORGENERATION_UPDATE]: 'Обновлёно поколение процессоров',
    [UserActionType.CONFIGURATOR_PROCESSORGENERATION_DELETE]: 'Удалёно поколение процессоров',
    ...
    [UserActionType.CONFIGURATOR_SERVERGENERATION_ADD]: 'Добавлено поколение серверов ',
    [UserActionType.CONFIGURATOR_SERVERGENERATION_UPDATE]: 'Обновлёно поколение серверов',
    [UserActionType.CONFIGURATOR_SERVERGENERATION_DELETE]: 'Удалёно поколение серверов',
    ...
    [UserActionType.PROFILE_UPDATE_SETTINGS]: 'Обновлены настройки профиля пользователя',
