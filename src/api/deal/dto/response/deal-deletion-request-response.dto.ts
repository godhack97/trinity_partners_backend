...
export class DealDeletionRequestResponseDto {
  ...
  @ApiProperty({ description: 'ID администратора, обработавшего заявку', nullable: true })
  processed_by_id?: number;

  @ApiProperty({ description: 'Email администратора, обработавшего заявку', nullable: true })
